...
class InheritedCrmLeadLost(models.TransientModel):
    ...
    def action_inherit_lost_reason_apply(self):
        ...
        mail_body = "<p>Service Request </p>"+ service_request.name+ "<p>has been lost due to </p>" +"<h5> "+ self.lost_reason_id.name +" </h5>"+ " <p>Please cancel it’s invoice and other accounting entries accordingly</p>"
