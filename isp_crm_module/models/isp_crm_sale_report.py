        ...
        select_str = """
            WITH currency_rate as (%s)
             SELECT min(l.id) as id,
                    ...
                    count(*) as nbr,
                    a.corporate_otc_amount as corporate_otc_amount,
                    a.toal_amount_mrc as toal_amount_mrc,
                    a.toal_amount_otc_mrc as toal_amount_otc_mrc,
                    s.name as name,
    ...
    def _group_by(self):
        group_by_str = """
            GROUP BY l.product_id,
                    ...
                    t.uom_id,
                    t.categ_id,
                    a.corporate_otc_amount,
                    a.toal_amount_mrc,
                    a.toal_amount_otc_mrc,
                    s.name,
                    s.date_order,
                    s.confirmation_date,
                    s.partner_id,
